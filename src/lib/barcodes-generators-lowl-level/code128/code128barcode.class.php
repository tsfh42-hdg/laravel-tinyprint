...
/* @(#) $Header: /sources/code128php/code128php/code128barcode.class.php,v 1.6 2007/11/10 13:34:19 harding Exp $
 *
 * code128barcode
 *
            ...
            if ((($i + 3 < $limit)
                ...
                if (!$this->_current_code)
                    ...
                    $this->_actual_code = $this->_current_code = '_CODEC';
                        ...
                        && preg_match('#[0-9]{2}#',$data[$i].$data[$i+1])
                        && $this->_current_code == '_CODEC') {
